...
export default function App() {
  ...
  return (
    <div className="min-h-screen theme-bg pb-28 transition-colors duration-500">
      ...
      <nav className={`fixed bottom-0 left-0 w-full z-40 flex justify-around items-center px-4 pb-4 pt-2.5 shadow-[0_-5px_20px_rgba(0,0,0,0.5)] ${isConsoleMode ? "bg-[#0a0b0d] border-t border-white/10 rounded-none" : "bg-[#034226] border-t-4 border-[#e1b12c] rounded-t-3xl"}`}>
