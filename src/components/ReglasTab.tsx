      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-12 premium-card border p-6 rounded-2xl shadow-lg relative overflow-hidden group">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 relative z-10">
            {/* 1er Puesto */}
            <div className="theme-card/10 backdrop-blur-sm border border-white/20 p-5 rounded-xl flex flex-col items-center justify-center text-center hover:theme-card/15 transition-all">
        ...
        <div className="md:col-span-12 h-52 rounded-2xl relative overflow-hidden border  shadow-lg group">
          <img 
